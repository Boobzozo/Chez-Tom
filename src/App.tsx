  ...
  <section className="relative min-h-screen flex items-center justify-center pt-20 bg-dark overflow-hidden">
    ...
    >
      <img
        ...
        alt="Salon de coiffure Tom Barbershop - Ambiance authentique et élégante"
    ...
    <div className="relative z-10 text-center px-6 max-w-4xl">
      ...
      >
        Tom <br /> <span className="italic text-gold">Barbershop</span>
      </motion.h1>
      <motion.div
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="h-full min-h-[500px] overflow-hidden rounded-[2.5rem] shadow-[0_32px_64px_-12px_rgba(0,0,0,0.15)] relative group">
                <img
                  ...
                  alt="Ambiance du salon Tom Barbershop"
                ...
                <div className="absolute bottom-10 left-10 right-10">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-[10px] uppercase tracking-[0.4em] text-paper/50 font-bold">L'esprit Tom Barbershop</span>
                    </div>
                  </motion.div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {images.map((img, index) => (
            ...
            >
              <img
                src={img.url}
                alt={img.caption || 'Réalisation du salon Tom Barbershop'}
  ...
  return (
    <footer id="contact" className="bg-dark text-paper py-24 px-6">
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-16">
        <div>
          <Monogram className="h-14 w-auto mb-5" aria-hidden="true" />
          <h2 className="text-3xl font-serif mb-8">Tom Barbershop</h2>
      ...
      <div className="max-w-7xl mx-auto mt-24 pt-8 border-t border-paper/5 text-center text-[10px] uppercase tracking-widest text-paper/20">
        <span>&copy; {new Date().getFullYear()} Tom Barbershop. Tous droits réservés.</span>
      </div>
    </footer>
  );
};
    ...
    <div className="min-h-screen bg-paper flex items-center justify-center p-6 selection:bg-gold selection:text-dark">
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-sm">
        <div className="text-center mb-8">
          <Monogram className="h-16 w-auto mx-auto text-dark" role="img" aria-label="Tom Barbershop" />
          <div className="mono-label text-gold-deep mt-4">Première connexion</div>
        </div>
    ...
    if (!sessionChecked) {
      return (
        <div className="min-h-screen bg-paper flex items-center justify-center">
          <span className="mono-label text-muted-deep animate-pulse">Tom Barbershop…</span>
        </div>
      );
    }
    ...
    return (
      <div className="min-h-screen bg-paper flex items-center justify-center p-6 selection:bg-gold selection:text-dark">
        ...
        >
          <div className="text-center mb-8">
            <Monogram className="h-16 w-auto mx-auto text-dark" role="img" aria-label="Tom Barbershop" />
            <div className="mono-label text-gold-deep mt-4">Espace gérant</div>
          </div>
          <div className="bg-white border border-hairline rounded-[4px] p-8 shadow-sm">
    ...
    <div className="min-h-screen selection:bg-gold selection:text-dark">
      ...
      {settings?.show_about === 'true' && (
        <section className="py-32 px-6 bg-white overflow-hidden">
          ...
          >
            <h2 className="text-4xl font-serif mb-2">L'histoire de Tom Barbershop</h2>
